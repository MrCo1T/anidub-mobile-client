...
public class MediaSearchListAdapter extends RecyclerView.Adapter<MediaSearchListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final MediaSearchListModel current = data.get(position);
